...
RETRIABLE_EXCEPTIONS = (
    ...
    IOError,
    httplib2.NotConnected,
    httplib2.IncompleteRead,
    httplib2.ImproperConnectionState,
    httplib2.CannotSendRequest,
    httplib2.CannotSendHeader,
    httplib2.ResponseNotReady,
